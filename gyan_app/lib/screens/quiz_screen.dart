...
class _QuizScreenState extends State<QuizScreen> {
  ...
  static const _input  = Color(0xFF232329);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Quiz Generator',
            style: GoogleFonts.inder(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w700)),
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          ...
          _SectionCard(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                Text('Questions:', style: GoogleFonts.inder(color: _muted, fontSize: 13)),
                Expanded(
                  child: SliderTheme(
                    data: SliderTheme.of(context).copyWith(
                      activeTrackColor: _blue,
                      inactiveTrackColor: _input,
                      thumbColor: _blue,
          ...
          ElevatedButton(
            ...
            child: _loading
                ...
                : Text('Generate Quiz',
                    style: GoogleFonts.inder(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w700)),
          ),
          ...
          if (_questions.isNotEmpty) ...[
            ...
            Row(children: [
              Text('Quiz', style: GoogleFonts.inder(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
              const Spacer(),
              Container(
                ...
                child: Text(
                  ...
                  style: GoogleFonts.inder(color: _diffColor, fontSize: 12, fontWeight: FontWeight.w700),
                ),
              ),
            ]),
            ...
            Container(
              ...
              child: Column(children: [
                Text(
                  ...
                  style: GoogleFonts.inder(color: _green, fontSize: 42, fontWeight: FontWeight.w700),
                ),
                const SizedBox(height: 6),
                Text('correct answers',
                    style: GoogleFonts.inder(color: _muted, fontSize: 14)),
                const SizedBox(height: 16),
                ElevatedButton(
                  ...
                  child: Text('Try Again', style: GoogleFonts.inder(color: Colors.white, fontWeight: FontWeight.w700)),
                ),
              ]),
            ),
...
class _QuestionCard extends StatelessWidget {
  ...
  static const _bg    = Color(0xFF18181F);
  static const _input = Color(0xFF232329);
  static const _blue  = Color(0xFF5865F2);
  static const _green = Color(0xFF57F287);
  static const _red   = Color(0xFFED4245);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const SizedBox(height: 8),
        Text(q.question,
            style: GoogleFonts.inder(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w600, height: 1.5)),
        const SizedBox(height: 14),
        ...
        if (q.isAnswered && q.explanation.isNotEmpty) ...[
          ...
          Container(
            ...
            child: Text(q.explanation,
                style: GoogleFonts.inder(color: Colors.lightBlueAccent, fontSize: 13, height: 1.6)),
          ),
        ],
      ]),
    );
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(title,
            style: GoogleFonts.inder(
                color: const Color(0xFF6E6E78), fontSize: 12, fontWeight: FontWeight.w700,
                letterSpacing: 0.5)),
        const SizedBox(height: 12),
        child,
      ]),
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: hint,
        hintStyle: GoogleFonts.inder(color: const Color(0xFF6E6E78), fontSize: 13),
        filled: true,
...
class _ProviderChip extends StatelessWidget {
  const _ProviderChip({required this.label, required this.selected, required this.onTap, required this.color});
  final String label;
  final bool selected;
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: selected ? color.withOpacity(0.15) : const Color(0xFF232329),
          ...
          child: Text(label,
              style: GoogleFonts.inder(
                  color: selected ? color : const Color(0xFF6E6E78),
...
class _DiffChip extends StatelessWidget {
  const _DiffChip({required this.label, required this.d, required this.selected, required this.onTap});
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          padding: const EdgeInsets.symmetric(vertical: 10),
          decoration: BoxDecoration(
            color: selected ? _color.withOpacity(0.15) : const Color(0xFF232329),
            border: Border.all(color: selected ? _color : Colors.white.withOpacity(0.1)),
            borderRadius: BorderRadius.circular(10),
          ),
          alignment: Alignment.center,
          child: Text(label,
              style: GoogleFonts.inder(
                  color: selected ? _color : const Color(0xFF6E6E78),
                  fontSize: 13, fontWeight: selected ? FontWeight.w700 : FontWeight.normal)),
        ),
      ),
    );
