        ...
        child: SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            _statRow(
                'Total Study Time',
                totalHrs < 1
                    ? '${user.totalMinutesStudied}m'
                    : '${totalHrs.toStringAsFixed(1)}h',
                t),
            _statRow('Sessions Completed', '${user.totalSessions}', t),
            _statRow('Current Streak', '${user.currentStreak} days', t),
            _statRow('Best Streak', '${user.bestStreak} days', t),
